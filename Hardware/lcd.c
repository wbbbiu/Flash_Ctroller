...
//3���Ż�����ṹ������Դ��?
//V4.1 20211208
//�޸�NT5510 ID��ȡ��ʽ,��Ϊ�ȷ�����Կ,Ȼ����?C500��C501,�Ӷ���ȡ��ȷ��ID(0X5510)
//V4.2 20211222
...
u16 LCD_ReadPoint(u16 x,u16 y)
{
    ...
    else                        //����IC(9341/5310/1963/7789/7796/9806)���Ͷ�GRAMָ��
    {
        LCD_WR_REG(0X2E);
    }
    ...
    //9341/5310/5510/7789/9806 Ҫ��2�ζ���
    b = LCD_RD_DATA();
...
void LCD_Scan_Dir(u8 dir)
{
    ...
    if (lcddev.id == 0X9341 || lcddev.id == 0X7789 || lcddev.id == 0X7796)   //9341 & 7789 Ҫ����BGRλ
    {
        regval |= 0X08;
    }
...
void LCD_Display_Dir(u8 dir)
{
    ...
    else     //����
    {
        ...
        if (lcddev.id == 0X5310 || lcddev.id == 0X7796)    //�����?5310 ���ʾ��? 320*480�ֱ���
        {
            lcddev.width = 480;
            lcddev.height = 320;
        }
...
{ 	
	...
	if(lcddev.id==0X9341||lcddev.id==0x7789||lcddev.id==0X5310||lcddev.id==0X5510||lcddev.id==0X1963 || lcddev.id == 0X7796 || lcddev.id == 0X9806)//������⼸��IC,������WRʱ��Ϊ���?
	{
		//��������дʱ����ƼĴ�����ʱ��?   	 							    
		FSMC_Bank1E->BWTR[6]&=~(0XF<<0);//��ַ����ʱ��(ADDSET)���� 	 
		FSMC_Bank1E->BWTR[6]&=~(0XF<<8);//���ݱ���ʱ������
		FSMC_Bank1E->BWTR[6]|=4<<0;		//��ַ����ʱ��(ADDSET)Ϊ3��HCLK =18ns  	 
        if(lcddev.id == 0X7789)
        {
            FSMC_Bank1E->BWTR[6]|=4<<8; 	//���ݱ���ʱ��(DATAST)Ϊ6ns*3��HCLK=18ns
        }
        else
        {
            FSMC_Bank1E->BWTR[6]|=4<<8; 	//���ݱ���ʱ��(DATAST)Ϊ6ns*3��HCLK=18ns

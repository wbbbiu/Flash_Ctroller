...
int _sys_write(FILEHANDLE fh, const unsigned char *buf, unsigned int len, int mode) { return 0; }
int _sys_read(FILEHANDLE fh, unsigned char *buf, unsigned int len, int mode) { return 0; }
